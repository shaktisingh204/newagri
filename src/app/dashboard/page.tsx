...
export default async function DashboardPage({ searchParams }: DashboardPageProps) {
  ...
  const [filterOptions, calendars, regions, stats] = await Promise.all([
    getFilterOptions(),
  ...
  return (
    <>
      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Crop Calendar Dashboard</h1>
          <p className="text-gray-500 mt-1">Explore crop calendars across countries and agro-ecological zones</p>
        </div>
        ...
        <div className="grid lg:grid-cols-5 gap-6">
          <div className="lg:col-span-3">
            ...
            <CropTimeline calendars={calendars} />
          </div>
          <div className="lg:col-span-2">
            <h2 className="text-xl font-semibold text-gray-800 mb-4">Regional Coverage</h2>
